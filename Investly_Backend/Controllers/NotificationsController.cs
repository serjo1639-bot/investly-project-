...
public class NotificationsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> TestEmail([FromServices] IEmailService emailService , [FromBody] string to )
    {
        await emailService.SendEmailAsync(to, "Investly Test Email", "Email service working by this message. ", false);
