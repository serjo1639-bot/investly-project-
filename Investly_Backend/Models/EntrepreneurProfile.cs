...
namespace Investly_Backend.Models
{
    ...
    public class EntrepreneurProfile
    {
        ...
        // Minimal blacklist rule: after 2 successful owner project deletes, project actions are blocked.
        [Required]
        public bool IsBlocked { get; set; } = false;

        // Counts successful owner deletions since the last admin unblock.
        [Required]
        public int DeletedProjectsCount { get; set; } = 0;

        // Lifetime count of how many times this entrepreneur has been automatically blocked.
        [Required]
