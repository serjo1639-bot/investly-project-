...
SECTORS += [
    ...
    "التأمين",
    "الصناعات الإسمنتية",
    "الخدمات اللوجستية للموانئ"
]
REGIONS = [
    "طرابلس", "بنغازي", "مصراتة", "سبها", "الزاوية",
    "الخمس", "سرت", "درنة", "البيضاء", "طبرق",
    "غريان", "ترهونة", "زليتن", "صبراتة",
    "زوارة", "يفرن", "نالوت", "الكفرة",
    "أوباري", "غات", "مرزق", "اجدابيا"
]
...
NOISE_POOL += [
    "ويرى بعض المستثمرين أن المشروع مليح ويستحق الدراسة بشكل أوسع.",
    "بحسب آراء محلية، فإن الطلب على هذه الخدمات في المنطقة لا يزال مرتفعاً.",
    "عدد من أصحاب الأعمال أكدوا أن السوق محتاج لمشروعات مشابهة.",
    "يشير مختصون إلى أن الظروف الحالية قد تساعد على نجاح المشروع.",
]
