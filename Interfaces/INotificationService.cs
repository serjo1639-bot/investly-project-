...
public interface INotificationService
{
    ...
    Task CreateManyAsync(IEnumerable<int> userIds, string type, string titleAr, string titleEn, string messageAr, string messageEn, int? projectId = null, int? investmentId = null);
}
