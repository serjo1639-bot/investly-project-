...
public class ProjectsController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateProject([FromBody] CreateProjectRequest request)
    {
        ...
        if (result == null)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be created. Make sure your entrepreneur profile exists and your account is allowed to create projects." });
        return Ok(result);
    }
    ...
    public async Task<IActionResult> UpdateProject(int id, [FromBody] UpdateProjectRequest request)
    {
        ...
        if (result == null)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be updated. Make sure the project exists, belongs to you, and can still be edited." });
        return Ok(result);
    }
    ...
    public async Task<IActionResult> DeleteProject(int id)
    {
        ...
        if (!result)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be deleted. Make sure the project exists and belongs to you." });
        return Ok(result);
    }
    ...
    public async Task<IActionResult> SubmitProject(int id)
    {
        ...
        if (!result)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be submitted. Only draft projects owned by you can be submitted for review." });
        return Ok(result);
    }
    ...
    public async Task<IActionResult> ApproveProject(int id)
    {
        ...
        if (!result)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be approved. It must exist and be pending review." });
        return Ok(result);
    }
    ...
    public async Task<IActionResult> RejectProject(int id, [FromBody] RejectProjectRequestDto request)
    {
        ...
        if (!result)
            return BadRequest(new ApiResponse { Success = false, Message = "Project could not be rejected. It must exist and be pending review." });
        return Ok(result);
    }
