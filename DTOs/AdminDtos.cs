...
// Entrepreneur blacklist row used by the admin dashboard/API.
public class BlacklistedEntrepreneurDto
{
    public int ProfileId { get; set; }
    public int UserId { get; set; }
    public string Email { get; set; } = string.Empty;
...
public class EscrowTransactionDto
{
    ...
    public int EscrowWalletId { get; set; }
    public string Type { get; set; } = string.Empty; // Funding | Release | Refund
