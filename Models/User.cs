...
namespace Investly_Backend.Models
{
    ...
    public class User
    {
        ...
        [Required]
        public bool IsBlocked { get; set; } = false; // Blocked for deleting published projects

        [Required]
        public int DeletedPublishedProjects { get; set; } = 0; // Tracks number of published projects deleted
